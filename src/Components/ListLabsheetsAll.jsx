...
import { Folders, Table2 } from "lucide-react";
import NewSpreadSheet from "./Modals/NewSpreadSheet";

function ListLabsheetsAll() {
...
export default ListLabsheetsAll;
