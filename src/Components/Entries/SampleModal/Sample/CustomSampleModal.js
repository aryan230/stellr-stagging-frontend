...
function CustomSampleModal({
  ...
  const [data, setData] = useState(
    Object.entries(insideData)
      .map((e) => ({
        name: _.startCase(e[0]),
        value: e[1],
      }))
      .filter((s) => s.name != "Sample Type Inside Custom")
  );
...
export default CustomSampleModal;
