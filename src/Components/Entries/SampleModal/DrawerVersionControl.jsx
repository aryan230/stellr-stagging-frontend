...
function DrawerVersionControl({ doc, setIsDrawerVersion }) {
  return (
  ...
  "
          >
            <label htmlFor="">Name of the sample</label>
            <input
              value={JSON.parse(doc.data).sampleName}
              type="text"
                    ...
                    {doc.versionControl &&
                      ...
                      doc.versionControl.map((v) => (
                        <tr className="bg-white border-b">
                          ...
                          <td className="px-6 py-4 text-indigo-600 hover:cursor-pointer">
                            View
                          </td>
                        </tr>
                      ))}
...
export default DrawerVersionControl;
