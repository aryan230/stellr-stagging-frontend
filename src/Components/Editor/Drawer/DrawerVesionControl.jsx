...
function DrawerVesionControl({
  doc,
  project,
  setVersionControlValue,
  setVersionControlTab,
  setIsDrawerVersionControl,
}) {
  return (
...
"
          >
            <label htmlFor="">Name of the Entry</label>
            <input
              value={doc.name}
              type="text"
            ...
            <div className="view-logs-inside">
              <div className="relative overflow-x-auto">
                <table className="w-full text-sm text-left text-gray-500">
                  ...
                  <tbody>
                    {doc.versionControl &&
                      doc.versionControl.length > 0 &&
                      doc.versionControl.map((v) => (
                        <tr className="bg-white border-b">
                          ...
                          <td
                            className="px-6 py-4 text-indigo-600 hover:cursor-pointer"
                            onClick={(e) => {
                              e.preventDefault();
                              setVersionControlTab(true);
                              setVersionControlValue(v);
                              setIsDrawerVersionControl(false);
                            }}
                          >
                            View
                          </td>
              ...
              <h2 className="log-message-h2">View Version</h2>
              <h2>Date</h2>
            </div> */}
              {/* {task &&
              task.logs &&
...
export default DrawerVesionControl;
