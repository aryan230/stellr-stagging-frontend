...
function ListSampleSubject({ index, doc, setSampleContent, setSampleModal }) {
  ...
  return (
    <tr className="bg-white border-b">
      ...
      <td className="px-6 py-4">{JSON.parse(doc.data).gender}</td>
...
export default ListSampleSubject;
